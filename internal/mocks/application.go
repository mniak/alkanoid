...
// Source: github.com/mniak/Alkanoid/application (interfaces: Application)
...
import (
	...
	application "github.com/mniak/Alkanoid/application"
)
...
func (m *MockApplication) CreateAccount(arg0 application.CreateAccountRequest) (application.CreateAccountResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAccount", arg0)
	ret0, _ := ret[0].(application.CreateAccountResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplication) CreateTransaction(arg0 application.CreateTransactionRequest) (application.CreateTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransaction", arg0)
	ret0, _ := ret[0].(application.CreateTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplication) GetAccount(arg0 application.GetAccountRequest) (application.GetAccountResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccount", arg0)
	ret0, _ := ret[0].(application.GetAccountResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
